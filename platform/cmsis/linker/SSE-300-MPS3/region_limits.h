...
/* Secure DDR4 */
#define S_DDR4_ALIAS              (0x80000000) /* DDR4_BLK1_BASE_S */
#define TOTAL_S_DDR4_SIZE         (0x10000000) /* 256 MB */

/* Non Secure Code */
#define NS_ROM_ALIAS              (0x00000000) /* ITCM_BASE_S */
#define TOTAL_NS_ROM_SIZE          (0x00080000) /* 512 kB */

/* Non Secure Data */
#define NS_RAM_ALIAS              (0x20000000) /* DTCM_BASE_S */
#define TOTAL_NS_RAM_SIZE          (0x00080000) /* 512 kB */

/* Non Secure DDR4 */
#define NS_DDR4_ALIAS             (0x80000000) /* DDR4_BLK1_BASE_S */
#define TOTAL_NS_DDR4_SIZE         (0x10000000) /* 256 MB */


/* Heap and Stack sizes for secure and nonsecure applications */
#define HEAP_SIZE                 (0x00040000) /* 1 KiB */
